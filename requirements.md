...
as a VS Code extension. It aims to provide a user-friendly interface for managing
online devices and project dashboards within the VS Code environment.
...
- **Device Type**: The type or category of the device (e.g., sensor, actuator,
  controller).
...
- **Add Device to Project**: Select a device from the online devices view and add
  it to the project dashboard. The device remains in the online devices view.
- **Remove Device from Project**: Remove a device from the project dashboard without
  affecting the online devices view.
...
- Implement modular design with clear separation between VS Code extension code
